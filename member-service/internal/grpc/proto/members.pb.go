...
const file_members_proto_rawDesc = "" +
	"\n" +
	"\rmembers.proto\x12\x05proto\"B\n" +
	"\x06Member\x12\x0e\n" +
	...
	"\x06member\x18\x01 \x01(\v2\r.proto.MemberR\x06member2Y\n" +
	"\x0eMembersService\x12G\n" +
	"\fCreateMember\x12\x1a.proto.CreateMemberRequest\x1a\x1b.proto.CreateMemberResponseB\bZ\x06/protob\x06proto3"
...
var file_members_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_members_proto_goTypes = []any{
	(*Member)(nil),               // 0: proto.Member
	(*CreateMemberRequest)(nil),  // 1: proto.CreateMemberRequest
	(*CreateMemberResponse)(nil), // 2: proto.CreateMemberResponse
}
var file_members_proto_depIdxs = []int32{
	0, // 0: proto.CreateMemberResponse.member:type_name -> proto.Member
	1, // 1: proto.MembersService.CreateMember:input_type -> proto.CreateMemberRequest
	2, // 2: proto.MembersService.CreateMember:output_type -> proto.CreateMemberResponse
